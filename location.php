...
<div class="bg-gray-100 min-h-screen pb-16">
    ...
    <div class="bg-white border-b border-gray-200 py-6 px-4 mb-6">
        <div class="max-w-[1440px] mx-auto">
            ...
            <h1 class="text-2xl md:text-3xl font-bold text-gray-800 mb-2">Agriculture & Industrial Machinery in
                <?php echo htmlspecialchars($currentPlace); ?></h1>
            <p class="text-sm text-gray-600 max-w-3xl">Get the best deals on heavy-duty equipment delivered directly to
            ...
            <?php foreach ($products as $product): ?>
                <div class="bg-white border border-gray-200 hover:shadow-lg transition-all h-full group flex flex-col rounded-sm overflow-hidden"
                    ...
                    <div class="flex-grow flex flex-col p-2 md:p-3">
                        ...
                        <div class="mt-auto">
                            <p class="text-[10px] md:text-[11px] text-gray-500 mb-2 truncate flex items-center gap-1"><i

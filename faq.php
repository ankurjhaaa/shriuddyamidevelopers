...
<div class="bg-white min-h-screen pb-16">
    ...
    <div class="bg-primary py-16 lg:py-20 px-6 text-center border-b border-primary relative overflow-hidden z-10">
        ...
        <div class="relative z-20 max-w-4xl mx-auto">
            <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4">FAQ</h1>
            <p class="text-gray-100 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">Find answers to the most common questions about our products, shipping, and heavy-duty services.</p>
        </div>
    </div>

    <!-- FAQ Content -->
    <div class="px-4 sm:px-6 lg:px-8 -mt-12 relative z-20 max-w-4xl mx-auto space-y-4">
        <div class="bg-white p-8 rounded-md border border-gray-200 space-y-6">
            <div class="space-y-6">
                
                <details class="group border border-gray-200 bg-white rounded-md open:border-primary transition duration-300">
